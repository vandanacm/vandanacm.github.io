...
const skills = [
  {
    ...
    description: "PyTorch, NLTK, Hugging Face, NumPy, Pandas, RAG, LangChain, Machine Learning, NLP, Large Language Models (LLMs), Multimodal Model, Agentic AI, Prompt Engineering",
  },
  {
    icon: Palette,
