...
const projects = [
  ...
  },
  {
    ...
    description: "Developed an unsupervised Î²-VAE system for music representation learning, compressing mel spectrograms into a structured 128-dim latent space that reveals genre clusters without any label supervision (GMM NMI = 0.28). Extended the model with contrastive auxiliary loss, disentanglement scoring, and conditional genre-guided generation as part of a 9-improvement research pipeline.",
    image: musicVaeImg,
    tags: ["Î²-VAE", "Deep Learning", "Mel Spectrograms", "GMM", "Python"],
    year: "2026",
