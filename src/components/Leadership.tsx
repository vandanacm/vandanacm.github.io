...
const volunteerActivities: RoleItem[] = [
  {
    ...
    period: "2026",
    description: "The Brains to Classrooms program reached over 100 elementary school students, focusing on lessons about how to protect the brain and why animals have different types of brains",
